...
// Project OrcScala
//
// $Id: CompileLogger.java 2035 2010-08-17 20:13:45Z dkitchin $
//
...
public interface CompileLogger {
	 ...
	 *  
	 * @param filename Name of file which compiler processing is beginning
	 */
	 ...
	 * 
	 * @param filename Name of file which compiler processing is complete
	 */
	public void endProcessing(String filename);
}
